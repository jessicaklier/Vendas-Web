...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext context) // criei um construtor com a realização da injeção de dependência
        {
            _context = context;
        }
        public void Seed() // Essa operação seed é responsavel por popular minha base de dados.
        {
            ...
            // instanciando o objeto Vendedor
            ...
            // Adicionando meus objetos no banco de dados, usando o Entity Framework
            ...
            // confirmando e salvando as alterações no meu banco de dados.
